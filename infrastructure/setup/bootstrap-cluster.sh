...
kubectl apply --server-side --kustomize ${REPO_ROOT}/kubernetes/virtops/bootstrap
...
kubectl apply -f ${REPO_ROOT}/kubernetes/virtops/flux/vars/cluster-settings.yaml
sops --decrypt ${REPO_ROOT}/kubernetes/virtops/flux/vars/cluster-secrets.sops.yaml | kubectl apply -f -

kubectl apply --server-side --kustomize ${REPO_ROOT}/kubernetes/virtops/flux/config
